...
import { getSavedVideos } from "../features/video/videoApi";
...
const SavedVideos = () => {
  ...
  return (
    <div className="max-w-screen-xl">
      <h1 className="text-white text-2xl font-bold mb-6">Saved Videos</h1>

      {!isLoading && videos.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center gap-3">
          <ThumbsUp size={48} className="text-zinc-700" />
          <p className="text-zinc-400 font-medium">No saved videos yet</p>
