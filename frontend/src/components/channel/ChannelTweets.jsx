        ...
        {isLoading ? (
          <div className="space-y-4">
            {Array.from({ length: 3 }).map((_, i) => (
              <div
                key={i}
                className="bg-zinc-900 rounded-2xl p-5 animate-pulse"
              >
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-2">
                      ...
                      {isOwner && (
                        <div className="flex items-center gap-3 shrink-0">
                          ...
                          <DeleteButton onClick={() => deleteMutation.mutate(tweet._id)}
                    ...
                    >
                      <ThumbsUp
                        size={14}
                        className={tweet.isLiked ? "fill-red-400" : ""}
                      />
                      {tweet.likesCount > 0 && formatCount(tweet.likesCount)}
                    </button>
                  </div>
                </div>
              </div>
